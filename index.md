...
As first author or corresponding author, Prof. Chao Yu has published more than 50 papers in top-tier international conferences and journals, including ICML, NeurIPS, ICLR, CVPR, ECCV, CoRL, IROS, ICRA, TMLR, and RAL, with over **6,000** citations on Google Scholar.My representative works include the multi-agent reinforcement learning algorithm [MAPPO](https://github.com/marlbenchmark/on-policy), which has received more than **3,000** Google Scholar citations, and [RLinf](https://github.com/RLinf/RLinf), a large-scale reinforcement learning training framework for embodied intelligence, which has accumulated over **3,000** GitHub stars.
